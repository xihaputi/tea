...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__EC3ED0D",
    appName: "Digital Tea Garden",
    appVersion: "0.1.0",
    appVersionCode: "100",
...
function initRuntimeSocketService() {
  const hosts = "198.18.0.1,10.222.222.1,192.168.1.184,192.168.47.1,192.168.17.1,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_NXIHsR";
